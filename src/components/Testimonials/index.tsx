...
const Testimonials = () => {
  const preTitle = "Testimonials";
  const title = "Here's what our customers said";
  const description = "Testimonials is a great way to increase the brand trust and awareness. Use this section to highlight your popular customers.";
  return (
    <TitledSection id="testimonials" preTitle={preTitle} title={title} desc={description}>
      <Container>
